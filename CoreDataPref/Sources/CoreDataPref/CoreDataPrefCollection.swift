...
public extension CoreDataPref {

    static func array(forKey key: String) throws -> [Any]? {
        let data = try CoreDataPref.data(forKey: key)
    ...
    static func set(value: [Any], forKey key: String) throws {
        ...
        try CoreDataPref.set(value: data, forKey: key)
    ...
    static func set<T: Codable>(value: T, forKey key: String) throws {
        ...
        try CoreDataPref.set(value: jsonData, forKey: key)
    }
